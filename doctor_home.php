...
<table class="container-fluid table">
    ...
    <tbody>
        ...
        <td><a href="php_appointment_approve.php?id=<?php echo $row['pname']; ?>" class="btn btn-outline-secondary "
                role="button">Approve</a></td>
        <td><a href="" class="btn btn-outline-secondary " role="button">Cancel</a></td>
        </td>
