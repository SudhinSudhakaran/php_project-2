        ...
        <div class="container-fluid bg-style media1">
            ...
            <div class="row">
                ...
                <div class="col-md-12 log-style">
                    <form action="php_login.php" name="loginform" method="post"
                        class="m-auto jumbotron text-light p-3 form-style rounded"
                        onclick="ValidateEmail(document.loginform.email)">


                        <h3 div class="text-center text-dark">Sign In</h3>
                        <input type="email" class="form-control inputcomponent mt-md-3 space" name="email"
                            required="required" placeholder="Email">

                        <input type="password" class="form-control inputcomponent mt-md-3 space" name="password"
                            required="required" placeholder="Password">

                        <button type="submit" class="btn-primary mt-md-3 px-5 rounded shadow" name="submit">Sign
                            IN</button>

                        <button type="button" class="btn btn-default loginbutton m-t-5">
                            <span class="google-button__icon">
                            </span>
                            <span class="google-button__text">Not Registred?<a href="registration.php">Sign
                                    Up</a></span>
                        </button>
