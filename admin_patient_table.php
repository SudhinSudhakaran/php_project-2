<!--Details of patients viewing by admin-->
<!----------------------------------------Header Starts--------------------------------------------------->
...
<table class="container-fluid table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="admin_patient_profile.php?id=<?php echo $row['pid'];?>"
                    class="btn btn-outline-secondary  btn-arrow-right" role="button">More ></a></td>
            </td>
        </tr>
        <?php 
					  }
