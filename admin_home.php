...
<table class="container-fluid table">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a href="" class="btn btn-outline-secondary  btn-arrow-right" role="button">More ></a></td>
            </td>
            <td><a href="php_doctor_approve.php?id=<?php echo $row['d_regid']; ?>"
                    class="btn btn-outline-secondary  btn-arrow-right" role="button">Approve +</a></td>
            </td>
